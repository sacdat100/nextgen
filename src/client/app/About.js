...
import FXDeals from './FXDeals.jsx';
          ...
          <Draggable>
            <Paper
              ...
              <strong style={style.strong}>
                <table width="100%">
                  <tr>
                    <td style={{width: '80%', verticalAlign: 'top', margin: 2, padding: 2}}>
                      <strong>
                    ...
                    <td style={{width: '20%', verticalAlign: 'top', textAlign: 'right', margin: 2, padding: 2}}>
                      ...
                      <Badge
                        badgeContent={10}
                        secondary={true}
                        badgeStyle={{top:0, right: 12, radius: 6}} />
                    </td>
                  </tr>
                </table>
              </strong>
          ...
          <Draggable>
            <Paper
              ...
              <strong style={style.strong}>
                <table width="100%">
                  <tr>
                    <td style={{width: '40%', verticalAlign: 'top', margin: 2, padding: 2}}>
                      <strong>
                        FX Rate
                      </strong>
                    </td>
                    <td style={{width: '60%', verticalAlign: 'top', textAlign: 'right', margin: 2, padding: 2}}>
                      <span style={style.tinyfont}>
                        Base Currency(SGD), 12/Feb/2018 01:29:00 PM
                      </span>
                    </td>
                  </tr>
                </table>
